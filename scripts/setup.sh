...
print_step "Railway Deployment Instructions (Backend)"
echo ""
echo -e "  ${BOLD}1. Create a Railway project${RESET}"
echo -e "     → https://railway.app/new"
echo ""
echo -e "  ${BOLD}2. Install Railway CLI${RESET}"
echo -e "     npm install -g @railway/cli"
echo ""
echo -e "  ${BOLD}3. Link and deploy${RESET}"
echo -e "     cd backend"
echo -e "     railway link"
echo -e "     railway up"
echo ""
echo -e "  ${BOLD}4. Set environment variables in Railway${RESET}"
echo -e "     railway variables set SUPABASE_URL=..."
echo -e "     railway variables set SUPABASE_SERVICE_KEY=..."
echo -e "     railway variables set HUGGINGFACE_API_TOKEN=..."
echo -e "     railway variables set SENTRY_DSN=..."
echo ""
echo -e "  ${BOLD}Or use GitHub Actions (automatic):${RESET}"
...
echo -e "  ${YELLOW}[ ]${RESET} NEXT_PUBLIC_API_URL            — Backend URL (e.g. https://api.railway.app)"
